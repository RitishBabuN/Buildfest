...
const INITIAL_ACTIONS: ActionItem[] = [
  ...
  },
  {
    ...
    deadline: '2026-08-05', // Overdue relative to current time
    status: 'Overdue',
    riskLevel: 'High',
    aiConfidence: 96
  }
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <button
          onClick={toggleView}
          className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-semibold text-sm text-white bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 shadow-lg shadow-sky-500/25 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
        >
          {viewMode === 'compact' ? (
            <>
            ...
            >
              ...
              <div className="md:col-span-7 glass-panel rounded-2xl p-6 flex flex-col justify-between">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="space-y-1">
                            <motion.h3
                              ...
                              className="text-sm font-semibold text-white group-hover:text-sky-400 flex items-center gap-2"
                            >
                              {item.title}
                ...
                <div className="mt-6 text-center">
                  ...
                  >
                    Click any card or toggle "View in Compliance Tracker" to morph layout
                  </button>
                </div>
              </div>
            </motion.div>
          ...
          {viewMode === 'expanded' && (
            ...
            >
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-800">
                ...
                <button
                  onClick={toggleView}
                  className="text-xs px-3 py-1.5 rounded-lg bg-slate-800 text-slate-300 hover:text-white border border-slate-700 flex items-center gap-1.5"
                >
                    ...
                    <div className="lg:col-span-5 space-y-1">
                      ...
                      <div className="flex items-center gap-3 pt-1">
                        <span className="text-[11px] text-purple-400 flex items-center gap-1">
                          <Bot className="w-3 h-3" /> AI Confidence: {item.aiConfidence}%
                        </span>
